...
settings_process = Settings_process(
    ...
    skip_registration = False, # This skips the click click circle circle step 
    ...
    # by_experiment = False, # Commenting out as not sure what it does
    # experiments = ['block pre edge vectors'], # Commenting out as not sure what it does
    # by_session = True, # Commenting out as not sure what it does
