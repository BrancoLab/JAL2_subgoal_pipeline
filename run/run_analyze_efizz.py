...
def main():
    # analyze_efizz(analysis_name = "rayleigh")
    ...
    analyze_efizz(analysis_name='EscapePattern', 
                  variable='residual: frac_route in homing&escape - bird_dist_shelter in explore') # must run because i changed the linear shift!
    analyze_efizz(analysis_name='EscapePattern', 
                  variable='residual: frac_route in homing&escape - speed in explore')
    analyze_efizz(analysis_name='EscapePattern', 
                  variable='residual: frac_route in homing&escape - distance_shelter in explore')
