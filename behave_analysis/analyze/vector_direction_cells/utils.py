...
def calculate_dirVector_between_coordinates(headCoords, goalCoords) -> np.ndarray:
    """A function that takes in two vectors of (x,y) coordinates for 
    the head and goal positions and computes a directional vector between them.
