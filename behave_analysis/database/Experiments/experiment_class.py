...
class Experiment(Mouse):
    ...
    barrier_removal_time: float # time in minutes and seconds when the barrier was removed e.g. 184.34 (184 minutes and 34 seconds)
    # Assign None if there was no removal of barrier