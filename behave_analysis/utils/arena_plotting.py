...
class Arena:
    ...
    def __init__(self, dim = 1024, ax=None, shelter_coordinates=None, condition=None, barrier_coordinates=None):
        self.scaling = dim/1024 # scale for 
        self.arena_radius = 460*self.scaling
        self.arena_center = 512*self.scaling
        self.ax = ax
        self.create_arena()
